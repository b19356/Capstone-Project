...
provider_sepDRG_Nat_State <- provider_sepDRG_Nat_State %>% 
  select (-c(DRG.Definition, DRG_Definition.y, DRG_Definition.y))
...
check <- data.frame(provider_sepDRG_Nat_State %>% group_by(DRG_Number) %>% 
